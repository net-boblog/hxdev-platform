...
public class UpdateHtmlIndex {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        updateIndex("D:\\Projetos\\hxdev-framework\\git\\hxdev-framework.github.io\\maven");
    }
    
    public static void main2(String[] args) throws FileNotFoundException {
        File file = new File("D:\\Projetos\\hxdev-framework\\git\\hxdev-framework.github.io\\maven\\.index\\");
        file.mkdirs();
    }
